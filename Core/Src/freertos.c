...
osThreadId bmp280MonitorHandle;
...
/* USER CODE BEGIN Header_taskBmp280Monitor */
/**
  * @brief  Function implementing the bmp280Monitor thread.
  * @param  argument: Not used 
  * @retval None
  */
/* USER CODE END Header_taskBmp280Monitor */
__weak void taskBmp280Monitor(void const * argument)
{
  /* USER CODE BEGIN taskBmp280Monitor */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END taskBmp280Monitor */
}

/* USER CODE BEGIN Header_taskBluetooth */
/**
* @brief Function implementing the bluetooth thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_taskBluetooth */
__weak void taskBluetooth(void const * argument)
{
  /* USER CODE BEGIN taskBluetooth */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END taskBluetooth */
}
